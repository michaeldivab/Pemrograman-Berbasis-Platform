document.getElementById('submitBtn').addEventListener('click', function() {
    ...
    document.getElementById('submitBtn').style.display = 'none'; // menyembunyikan tombol OK setelah mengisi nama dan jumlah
    ...
    document.getElementById('submitPilihanBtn').addEventListener('click', function() { // Menambahkan event listener untuk tombol OK baru
        ...
        document.getElementById('submitPilihanBtn').style.display = 'none'; // menyembunyikan tombol OK sebelumnya
        document.getElementById('submitRadioBtn').addEventListener('click', function() { // Menambahkan event listener untuk tombol OK baru
            ...
            if (pilihanRadio) {
                ...
                document.getElementById('hasil').style.display = 'block';
                        ...
                        // Menghilangkan tombol OK setelah memilih
                document.getElementById('submitRadioBtn').style.display = 'none';
            } else {
